...
namespace StartfieldLibrary
{
    ...
    public class Starfield : IDisposable
    {
        ...
        /// </summary>
        static readonly Color backgroundColor = new Color(84, 134, 135);
        ...
        public void LoadContent()
        {
            ...
            cloudTexture = contentManager.Load<Texture2D>("Clouds");

            // load the cloud effect
            cloudEffect = contentManager.Load<Effect>("CloudsEffect");
